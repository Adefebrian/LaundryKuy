...
class Canvas1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      **/
                  Text(
                '''Selamat Datang di aplikasi LaundryKuy
silahkan login untuk melanjutkan, apabila
belum memiliki akun silahkan untuk daftar 
terlebih dahulu''',
                overflow: TextOverflow.visible,
                textAlign: TextAlign.left,
                style: TextStyle(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/Canvas2'),
                child: Container(
                  width: 375.0,
                  height: 50.0,
                  decoration: BoxDecoration(
