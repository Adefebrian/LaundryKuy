...
/* FigmaFrame 8 */
class Canvas8 extends StatelessWidget {
  @override
    ...
    return Material(
      ...
      **/
                                ...
                                child: Container(
                                  ...
                                  child: SvgWidget(painters: [
                                    SvgPathPainter.fill()
                                      ..addPath(
                                          'M0 0L375 333.5L375 667L0 667L0 0Z')
                                      ..setLinearGradient(
      ...
      **/
                                ...
                                child: Container(
                                  ...
                                  child: SvgWidget(painters: [
                                    SvgPathPainter.fill()
                                      ..addPath(
                                          'M0 0L0 333.5L375 333.5L375 0L0 0Z')
                                      ..color =
                                          Color.fromARGB(255, 255, 255, 255),
      ...
      **/
                                        ...
                                        child: SvgWidget(painters: [
                                          SvgPathPainter.fill()
                                            ..addPath(
                                                'M0 0L0 44.5L375 44.5L375 0L0 0Z')
      ...
      **/
                                    ...
                                    Positioned(
                                      child:
                                          /**
       * Instance 'Overrides/Icons/Icon 4 active'
      **/
                                          Container(
                                        width: 24.0,
                                        height: 24.0,
      ...
      **/
                                  GestureDetector(
                                onTap: () =>
                                    Navigator.pushNamed(context, '/Canvas9'),
                                child: Container(
                                  width: 197.0,
                                  height: 60.0,
                                  decoration: BoxDecoration(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Stack(children: [
                                      Positioned(
                                        child:
                                            /**
       * Rectangle '110210449_2678802182364508_4775586163546237643_n 1'
      **/
                                            ClipRRect(
                                          borderRadius:
      ...
      **/
                                  GestureDetector(
                                onTap: () =>
                                    Navigator.pushNamed(context, '/Canvas10'),
                                child: Container(
                                  width: 335.0,
                                  height: 50.0,
                                  decoration: BoxDecoration(
