...
/* FigmaFrame 6 */
class Canvas6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Material(
        ...
        child: ClipRRect(
          ...
          child: Stack(children: [
            ...
            Positioned(
              child:
                  /**
       * Rectangle '2020-09-16-165254_458x669_scrot-framed 1'
      **/
                  Container(
                width: 508.0,
                height: 719.0,
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: ExactAssetImage(
                        "assets/images/1279dab11179ee6d0e7b80ae0422edf3bf4ef86b.png",
                      ),
                      fit: BoxFit.cover,
                    )),
                child: ClipRRect(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/Canvas7'),
                child: Container(
                  width: 335.0,
                  height: 46.0,
                  decoration: BoxDecoration(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/Canvas5'),
                child: Container(
                  width: 30.0,
                  height: 30.0,
                  decoration: BoxDecoration(
